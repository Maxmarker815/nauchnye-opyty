...
CONTENT = {
202: {"materials":"Трубочка, пищевой краситель, самим подготовить: ватные палочки, ножницы, двусторонний вспененный скотч.",
"steps":["Отрежьте от трубочки небольшой кусочек (около 5 см) и разрежьте его пополам вдоль.",
"Ножницами вырежьте на одной стороне заготовки лепестки цветка.",
"На другую, не разрезанную сторону наклейте кусочек вспененного скотча и оберните заготовку вокруг ватного наконечника палочки.",
"Капните немного пищевого красителя на ватный наконечник — так же можно сделать ещё несколько таких же красивых цветков разного цвета."],
"principle":"Это творческая поделка, а не научный эксперимент — отдельного научного объяснения к ней нет."},
}
